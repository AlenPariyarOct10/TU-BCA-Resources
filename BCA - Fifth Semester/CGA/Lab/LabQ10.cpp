...
int main()
{
    ...
    printf("Enter the coordinates for the clipping rectangle (rx1, ry1, rx2, ry2): ");
    ...
    printf("Enter the coordinates for the polygon:\n");
    for (i = 0; i < n; i++) {
        scanf("%f%f", &x[i], &y[i]);
    }
    ...
    outtextxy(10, 470, "Press any key to proceed...");
